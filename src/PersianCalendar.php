        ...
        while ($i < strlen($format)) {
            ...
            switch ($subtype) {
                ...
                case "d":
                    ...
                    if ($persianNumber == 1) $result .= self::Converter2farsi($result1);
                    else $result .= $result1;
                    break;
                case "D":
                    $result1 = date("D", $need);
                ...
                case "m":
                    ...
                    break;
                case "M":
                    $result .= self::shortMonthName($Dmonth);
                    break;
                case "n":
                    $result1 = $Dmonth;
                    if ($persianNumber == 1) $result .= self::Converter2farsi($result1);
...
//Find Number Of Days In This Month
    ...
    public static function shortMonthName($month)
    {
    ...
    public static function Converter2farsi($srting)
    {
        $num0 = "&#1776;";
        $num1 = "&#1777;";
        $num2 = "&#1778;";
